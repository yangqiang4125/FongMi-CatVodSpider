...
public class Miss extends Spider {
    ...
    public String homeContent(boolean filter) throws Exception {
        ...
        for (Element a : doc.select("nav a")) {
            ...
            filters.put(typeId, Arrays.asList(new Filter("filters", "过虑", Arrays.asList(new Filter.Value("全部", ""), new Filter.Value("单人作品", "individual"), new Filter.Value("中文字幕", "chinese-subtitle")))));
        }
